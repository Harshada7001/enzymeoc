            ...
            <?php foreach ($blogs as $blog): ?>
                <div class="card">
                    <div class="card-header">
                        <img src="uploads/<?php echo ($blog['blogimg']); ?>" alt="" />
                    </div>
                    <div class="card-body">
                        <span class="tag tag-teal"><?php echo $blog['blogid']; ?></span>
                       <a href="<?=base_url();?>blogdetail"><h4><?php echo $blog['blogtitle']; ?></h4></a>
                       
                            <p><?php echo $blog->blogtext; ?> </p>
